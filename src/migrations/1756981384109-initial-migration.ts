...
export class InitialMigration1756981045941 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "payment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "provider" "public"."payment_provider_enum", CONSTRAINT "PK_payment_request" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "api-key" ("id" character varying NOT NULL, "available_providers" "public"."payment_provider_enum" array NOT NULL, CONSTRAINT "PK_api_key" PRIMARY KEY ("id"))`,
    );
  }
